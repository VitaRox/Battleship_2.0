  ...
  for (let r = 0; r < 10; r++) {
    ...
    for(let c = 0; c < 10; c++) {
      ...
      if (gameArray[index] === miss) {
        column = "<div class='grid-item'><img src='/public/images/miss.png' alt='1' height='25' width='25'></div>";
      } else if (gameArray[index] === hit) {
        column = "<div class='grid-item'><img src='/public/images/hit.png' alt='1' height='25' width='25'></div>";
      } else {
        column = "<div class='grid-item'><img src='/public/images/water.png' alt='1' height='25' width='25'></div>";
      }
      table += column;
      if (c === 9) {
        table += "</tr>";
...
exports.updateGameArray = (guessX, guessY) => {
...
//   :getUpdateDisplay() = getUpdateDisplay(),
//   :dispBoard() = dispBoard()
// };